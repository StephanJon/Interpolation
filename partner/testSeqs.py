...
def main():
    ...
    x = 6.5 #input("What x value would you like to get the y value for?: ")
    y = test1.linVal(x)
    ...
    test4.add(1, 2)
    test4.add(0, 0)
    if (test4.elements[0] == 0 and test4.elements[1] == 1 and test4.elements[2] == 2):
        test_add = "Pass"
    else:
        test_add = "Fail"
    if (test4.size() == 3):
    ...
    if (test4.get(1) == 1):
        ...
        test_get = "Fail"
    test4.rm(2)
    if (len(test4.elements) == 2):
        test_rm = "Pass"
    else:
        test_rm = "Fail"
    test4.set(1, 1234)
    if (test4.elements[1] == 1234):
        test_set = "Pass"
    else:
        test_set = "Fail"
